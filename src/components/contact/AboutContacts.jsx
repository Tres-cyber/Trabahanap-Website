    ...
    <section className='w-full px-6 py-16 bg-white dark:bg-gray-900'>
      <div className='max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8'>
        ...
        <motion.div
          ...
          className='rounded-2xl p-8 md:p-10  bg-blue-500 dark:bg-blue-600 text-white flex flex-col justify-between'
        >
        ...
        <motion.div
          ...
          className='rounded-2xl bg-white dark:bg-gray-800 p-8 md:p-10 shadow-xl text-gray-900 dark:text-gray-100'
        >
          ...
          <form className='mt-8 space-y-5'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <input
                ...
                className='w-full bg-purple-50 dark:bg-gray-700 rounded-full px-4 py-3 border border-purple-200 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-400 placeholder:text-gray-400 dark:placeholder:text-gray-300'
              />
              <input
                type='text'
            ...
            <textarea
              ...
              rows='5'
              className='w-full bg-purple-50 dark:bg-gray-700 rounded-2xl px-4 py-3 border border-purple-200 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-400 placeholder:text-gray-400 dark:placeholder:text-gray-300'
            />
            <button
              type='submit'
